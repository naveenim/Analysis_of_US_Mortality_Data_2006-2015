...
First run ‘Co-occurring_interactive.R’. Then run ‘app.R’. This will launch the
...
(Note: While running ‘Co-occurring_interactive.R’, the file path to your local machine directory may need to be changed.)
